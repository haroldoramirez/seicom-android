...
## Vamos atualizar o arquivo _activity\_lista\_contatos_.xml:
```xml
...
## No _ListaContatosActivity_ adicionar um array de String e inseri-lo a nossa _ListView_ utilizando um _adapter_:
```java
@Override
